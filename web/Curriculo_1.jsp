...
<html>
    ...
    <body>
        ...
        <form action="CadCurriculo_1.jsp">
        Nome:  
        <%
        ...
        <br/>
            Área de atuação: <select name="Area_Atuacao">
                <%
                List<AreaAtuacaoSistema> areaatu = repAreaAtuacao.BuscarTodos();
             ...
             Universidade: <select name="Universidade">
                <%
                List<Universidade> uni = repUniversidade.BuscarTodos();
             ...
             Cursos: <select name="Curso">
                <%
                List<Curso> curso = repCurso.BuscarTodos();
             ...
             <br/>
              Empresa : <select name="Empresa">
                <%
                List<Empresa> empresa = repEmpresa.BuscarTodos();
